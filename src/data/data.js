export const data = [
  {
    ...
    desc: 'desktop application will allow transparency in management within the restaurant thanks to the implementation of a computerized system in front of support data entry sectors such as: food management shift planning, inventory management,  customer management orders, purchasing management and sales management.',
    video:
      'https://res.cloudinary.com/dgcdmrj7x/video/upload/v1705335913/Application_de_Gestion_Cafe_Restaurant_VB.NET_eo2qjg.mp4',
    link: '',
    git: '',
  },
  {
...

  {
    ...
    video: 'https://res.cloudinary.com/dgcdmrj7x/video/upload/v1705627144/0119_11_ohdb5h.mp4',
    link: '',
